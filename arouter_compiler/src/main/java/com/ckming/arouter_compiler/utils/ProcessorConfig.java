package com.ckming.arouter_compiler.utils;

public interface ProcessorConfig {

    // @ARouter注解 的 包名 + 类名
    String AROUTER_PACKAGE =  "com.ckming.arouter_annotation.ARouter";
    ...
    // ARouter api 包名
    String AROUTER_API_PACKAGE = "com.ckming.arouter_api";
